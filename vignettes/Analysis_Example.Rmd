...
```{r Createe Object, message=FALSE, warning=FALSE}
...
# Start Analysis
```{r normalizzation, message=FALSE, warning=FALSE}
...
## Mapped Reads
```{r plot_mapped_reads, message=FALSE, warning=FALSE}
...
## Boxplot
```{r  distribution_mapped_reads boxplot, message=FALSE, warning=FALSE}
...
## Boxplot
```{r  distribution_mapped_reads density, message=FALSE, warning=FALSE}
plot <- distribution_mapped_reads(
...
## Control Genes
```{r Control Genes,  message=FALSE, warning=FALSE}
...
## Barcode Lost
```{r  plot_barcode_lost, message=FALSE, warning=FALSE}
...
### For Sample
```{r  Plot MDS Sample, message=FALSE, warning=FALSE}
plot_MDS(screenR_Object = object) 
```


### For Treatment
```{r  Plot MDS Treatment, message=FALSE, warning=FALSE}
...
### For Day
```{r  Plot MDS Day, message=FALSE, warning=FALSE}
...
## Compute Metrics
```{r  compute_metrics, message=FALSE, warning=FALSE}
# 2DG
...
## Z-score hit
```{r  Z-score hit, message=FALSE, warning=FALSE}
zscore_hit_Met <- list(
...
## CAMERA
```{r  CAMERA, message=FALSE, warning=FALSE}
groupss <- c(
    rep("T0/T48", 4),
...
## ROAST
```{r ROAST, message=FALSE, warning=FALSE}
roast_hit_Met <- list(
    Day3 = find_roast_hit(
        screenR_Object = object, matrix_model = matrix_model,
        contrast = "Day3_Met"
...
## Find Common Hit 
```{r Common Hit,  message=FALSE, warning=FALSE}
