...
## ----github install, eval=FALSE, message=FALSE, warning=TRUE------------------
...
## ----read_data, message=FALSE, warning=TRUE-----------------------------------
data(count_table)
...
## ----Create_Object, message=FALSE, warning=TRUE-------------------------------
...
## ----normalizzation, message=FALSE, warning=TRUE------------------------------
object <- normalize_data(object)
object <- compute_data_table(object)

## ----plot_mapped_reads, message=FALSE, warning=TRUE---------------------------
...
## ----distribution_mapped_reads_boxplot, message=FALSE, warning=TRUE-----------
...
## ----distribution_mapped_reads_density, message=FALSE, warning=TRUE-----------
plot <- distribution_mapped_reads(
...
## ----plot_barcode_lost, message=FALSE, warning=TRUE---------------------------
...
## ----Plot_MDS_Sample, message=FALSE, warning=TRUE-----------------------------
plot_MDS(screenR_Object = object) 

## ----Plot_MDS_Treatment, message=FALSE, warning=TRUE--------------------------
...
## ----Plot_MDS_Day, message=FALSE, warning=TRUE--------------------------------
...
## ----compute_metrics, message=FALSE, warning=TRUE-----------------------------
# 2DG
...
## ----Z_score_hit, message=FALSE, warning=TRUE---------------------------------
zscore_hit_TRT <- list(
...
## ----CAMERA, message=FALSE, warning=TRUE--------------------------------------
...
## ----ROAST, message=FALSE, warning=TRUE---------------------------------------
roast_hit_TRT <- list(
...
## ----Common_Hit,  message=FALSE, warning=TRUE---------------------------------
