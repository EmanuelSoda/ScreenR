...
create_test_object <- function(){
  ...
  colnames(CountTable_THP1_CONTROL_vs_MET) <-
    c("Barcode","T0", "T48_postPURO",
      "Day3_Met_A", "Day3_Met_B","Day3_Met_C",
      "Day3_DMSO_A", "Day3_DMSO_B", "Day3_DMSO_C",
      "Day6_Met_A", "Day6_Met_B","Day6_Met_C",
...
test_that("Compute Metrics ", {
  ...
  table <- compute_metrics(object, treatment = "Met",
                           control = "DMSO", day = "Day3")
...
test_that("find_common_hit 2", {
  ...
  control <- c("Day3", "Day6", "Day3")
  table <- compute_metrics(object, control = "Met",
                           treatment ="DMSO", day = "Day3")
...
test_that("Plot common Hit", {
  ...
  plot <- suppressWarnings(plot_common_hit(hit_zscore, hit_camera,
                  hit_zscore, show_percentage = F))
...
#   plot <- plot_barcode_hit(screenR_Object = object,
#                    matrix_model = matrix,
#                    hit_common = hit, contrast =  "Treated")
# })
...
test_that("filter_by_variance", {
  ...
  data <- filter_by_variance(genes =   c("SEPT5"),
...
test_that("Plot Boxplot", {
  ...
  plot_boxplot(screenR_Object = object,
               genes = c("SEPT5", "GLS"),
               group_var = c("T0", "T48","Met"),
               nrow = 1, ncol = 2,
